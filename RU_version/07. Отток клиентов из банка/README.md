...
**Навыки и инструменты:** Pandas, Matplotlib, Scikit-learn, Upsampling, Downsampling, борьба с дисбалансом данных.
...
**Ключевые слова проекта:** классификация, подбор гиперпараметров, выбор модели машинного обучения, борьба с дисбалансом данных.